...
def file_path_save():
    ...
    files = sorted(glob.glob("C:/Users/bitcamp/anaconda3/Lib/site-packages/darknet/train/data/*.jpg"))
    ...
    for i in range(len(train_files)):
        ...
        f = open("C:/Users/bitcamp/anaconda3/Lib/site-packages/darknet/train/train.txt", 'a')
        # files가 0번째부터 train_files의 수대로 경로가 적히는 리스트 train.txt 형성
        f.write(files[i]+"\n")

    for j in range(len(val_files)):
        f = open("C:/Users/bitcamp/anaconda3/Lib/site-packages/darknet/train/valid.txt", 'a')
        f.write(files[j]+"\n")
