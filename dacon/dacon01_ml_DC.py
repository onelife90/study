...
# DecisionTree
# score:  -0.005419558438117649
# MAE:  1.7843421522013718

#5. submit할 파일 생성
submit = pd.DataFrame(submit, index=np.arange(10000,20000))
submit.to_csv('./data/dacon/comp1/submission_DC.csv', header=["hhb","hbo2","ca","na"], index=True, index_label="id")
