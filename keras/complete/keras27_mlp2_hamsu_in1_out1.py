...
# 하이퍼파라미터튜닝
# epochs=500, input1노드=3,1000,10,9000,10 output노드=100,80,60,40,20,10,1
#RMSE :  7.34e-05(1) / 7.15e-05(2) / 7.84e-05(3)
#R2 :  0.999999999993(1) / 0.999999999994(2) / 0.999999999992(3)
