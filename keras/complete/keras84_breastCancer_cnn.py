...
model.add(Conv2D(60, (2,2), padding='same', activation='softmax'))
model.add(Conv2D(120, (2,2), padding='same', activation='softmax'))
model.add(Conv2D(180, (2,2), padding='same', activation='softmax'))
model.add(Conv2D(240, (2,2), padding='same', activation='softmax'))
model.add(MaxPooling2D(pool_size=3, padding='same'))
model.add(Dropout(0.1))
model.add(Conv2D(210, (2,2), padding='same', activation='softmax'))
model.add(Conv2D(150, (2,2), padding='same', activation='softmax'))
model.add(Conv2D(90, (2,2), padding='same', activation='softmax'))
