# 122 그대로 카피해서 123 완성
# embedding을 빼고 Conv1D 완성
# Conv1D(3차원) input_shape(2차원)
...
model.add(Conv1D(5, kernel_size=2, input_shape=(5,1)))
# kernel_size=2이기 때문에 (5,1) -> (4,5)가 됨
model.add(Flatten())
